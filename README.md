...
**~17KB gzipped** | **1024 tests** | **Zero dependencies** | **No build step** | **[Up to 678x faster re-renders than React](#performance)**
...
> Benchmarks: `tests/benchmark/` — React 19.2, xhtmlx 0.4.1, JSDOM, 3 runs averaged.
